...
import com.yesway.wechat.platform.util.HttpClientUtil;
import com.yesway.wechat.platform.util.WechatConstants;
...
public class Menu {
	...
	public static void main(String[] args) {
		...
		//创建菜单
		String appid="wx0a5131dad292f2f2";
		String secret="47fa6b1c3fbed1847774012b1367177a";

		String token= WechatUtil.getAccessToken(appid,secret);
		String url= WechatConstants.MENU_CREATE_URL+"?access_token=" + token;
//
		HttpClientUtil.doSSLPost(url, null, menu.buildJsonMenu(), "utf-8");


		//查询菜单

//		HttpClientUtil.doSSLGet(WechatConstants.MENU_GET_URL + "?access_token=" + token, null, "utf-8");

//		HttpClientUtil.doSSLGet(WechatConstants.MENU_DELETE_URL + "?access_token=" + token, null, "utf-8");
	}
}
